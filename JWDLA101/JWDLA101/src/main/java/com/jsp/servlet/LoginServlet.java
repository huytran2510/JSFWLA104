...
import com.jsp.dao.AccountDaoImpl;
...
public class LoginServlet extends HttpServlet {
    ...
    //com.example.jspdemo.filter.JDBCFilter.doFilter(JDBCFilter.java:108)
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (account == null || password == null || account.isEmpty() || password.isEmpty()) {
            ...
            try {
                ...
                user = accountDao.findUserByUsername1(account, password);
